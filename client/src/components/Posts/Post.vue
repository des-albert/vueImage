      ...
      <v-flex xs12>
        <v-card hover>
          <v-card-title>
            ...
            <v-spacer />
            <v-icon @click="goToPreviousPage" color="info" large>arrow-back</v-icon>
          </v-card-title>
          <v-tooltip right>
            <template v-slot:activator="{ on }">
              <v-img v-on="on" @click="toggleImageDialog" :src="getPost.imageUrl" id="post___image" height="80vh" contain> </v-img>
            </template>
          ...
          <v-dialog v-model="dialog">
            <v-card>
              <v-img :src="getPost.imageUrl" height="80vh" contain />
            </v-card>
          </v-dialog>
        ...
        <v-flex xs12>
          <v-list subheader two-line>
            ...
            <template v-for="message in getPost.messages">
              ...
              <v-list-item avator inset :key="message.title">
                <v-list-item-avatar>
